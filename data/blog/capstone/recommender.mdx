...
> This is the third of a multi part series that details the processes behind [FastParliament](https://fparl.bearylogical.net). You may view the previous post [here](/blog/capstone-summarizer/): 
...
In the [previous](/blog/capstone-summarizer/) article, sentence vectors were created out of the TF-IDF method where the vector represented weighted frequencies of a particular word in a text.
...
![Semantic Representation from word vectors. Obtained from [tensorflow docs](https://www.tensorflow.org/tutorials/representation/word2vec).](https://www.tensorflow.org/images/linear-relationships.png)
_Semantic Representation from word vectors. Obtained from [tensorflow docs](https://www.tensorflow.org/tutorials/representation/word2vec)._
