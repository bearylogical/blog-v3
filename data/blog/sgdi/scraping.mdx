...
While working on my [sgdi project](/blog/sgdi/sgdi-intro) , I wanted something more robust over existing scraping methods implemented by [SpaceRacoon](https://github.com/spaceraccoon/sgdi-scraper) and [HXChua](https://github.com/hxchua/datadoubleconfirm/blob/master/notebooks/StatutoryBoardSG.ipynb) to collect data for the (forseeable long term). 
...
![sgdi flow](/static/images/sgdi_data/sgdi_flow.png)
_Flow of the SGDI task_
...
![scrapy timeline](/static/images/sgdi_data/scrapy_timeline.png)
